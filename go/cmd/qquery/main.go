...
func main() {
	...
	vecs, err := embed.EmbedBatch([]string{cfg.Query}, cfg.EmbedURL, cfg.EmbedModel, 1)
	...
	results, err := qdrantClient.QueryPoints(cfg.Collection, queryVector, cfg.Limit, cfg.Hybrid)
	if err != nil {
